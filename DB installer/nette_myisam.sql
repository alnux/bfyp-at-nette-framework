...
--
-- Servidor: localhost
-- Tiempo de generación: 17-05-2015 a las 20:41:29
...
--
-- Base de datos: `nette_myisam`
--
CREATE DATABASE IF NOT EXISTS `nette_myisam` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `nette_myisam`;
